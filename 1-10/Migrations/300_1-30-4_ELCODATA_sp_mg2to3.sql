...
-- on sépare en deux parties, car sinon le SQL généré est trop long. 
-- on l'exécute en deux parties, qu'on stockera dans une table temporaire, pour reconcaténer les messages d'erreurs à la fin.
SET @SQL1 = ''
SET @SQL2 = ''
SET @message = ''
SET @colonnes = ''
