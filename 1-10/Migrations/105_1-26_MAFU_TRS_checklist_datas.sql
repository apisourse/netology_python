...
INSERT INTO T_CHECKLIST_DEFINITION (checklist_element_name, checklist_element_label, checklist_element_level, checklist_element_father_idr, checklist_element_order) 
SELECT 'MPNecessaryToObtainMaintainTypeCertification', '- Has the Change''s impact on TYPE CERTIF been analysed?<br>- Correct classification & consistent with TRS?', 30, id_definition_checklist, checklist_element_order+10
...
INSERT INTO T_CHECKLIST_DEFINITION (checklist_element_name, checklist_element_label, checklist_element_level, checklist_element_father_idr, checklist_element_order) 
SELECT 'S1ToBeEmbodiedBeforeRestrictionsCancelled', 'Is it clearly defined ? / to be used after type certif only.', 30, id_definition_checklist, checklist_element_order+10
...
INSERT INTO T_CHECKLIST_DEFINITION (checklist_element_name, checklist_element_label, checklist_element_level, checklist_element_father_idr, checklist_element_order) 
SELECT 'S2RegulationsInvolvedAndJustification', '- Are the regulations and justification correctly listed ?<br>- If Basic Change, provide Certification plan.<br>- If improvement CR or RFC, identify regulations involved and provide the MoC<br>- Coherence with field  &quot;CLASSIFICATION &quot; in sheet 1.', 30, id_definition_checklist, checklist_element_order+10
...
INSERT INTO T_CHECKLIST_DEFINITION (checklist_element_name, checklist_element_label, checklist_element_level, checklist_element_father_idr, checklist_element_order) 
SELECT 'S2ImpactOnApprovedDocumentation', 'Impacts identified and consistent with mod category?', 30, id_definition_checklist, checklist_element_order+10
...
INSERT INTO T_CHECKLIST_DEFINITION (checklist_element_name, checklist_element_label, checklist_element_level, checklist_element_father_idr, checklist_element_order) 
SELECT 'S4ImpactedStandardSpecification', '- Has the impact on standard Specification been analysed ?<br>- Has the need for an MSCN been considered ?', 30, id_definition_checklist, checklist_element_order+10
...
INSERT INTO T_CHECKLIST_DEFINITION (checklist_element_name, checklist_element_label, checklist_element_level, checklist_element_father_idr, checklist_element_order) 
SELECT 'S6DesignInvolvementDesignResponsible', 'Is it coherent with the detailed description, MP, and IS? Correctly named?', 30, id_definition_checklist, checklist_element_order+10
