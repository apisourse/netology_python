...
-- des_name
------------------------------------------------------------------------------------------------------------------
SELECT @id_attr = id_infobase FROM InfoBase WHERE object_value = 'des_name' AND table_name = 'V_Installation_Design_responsibility'
...
-- des_reasonforchange
------------------------------------------------------------------------------------------------------------------
SELECT @id_attr = id_infobase FROM InfoBase WHERE object_value = 'des_reasonforchange' AND table_name = 'V_Installation_Design_responsibility'
