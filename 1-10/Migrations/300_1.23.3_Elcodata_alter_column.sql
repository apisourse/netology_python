...
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic1_High_Column1 float NULL
	
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic1_Low_Column1 float NULL
	
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic2_High_Column1 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic2_Low_Column1 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic1_High_Column2 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic1_Low_Column2 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic2_High_Column2 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic2_Low_Column2 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic1_High_Column3 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic1_Low_Column3 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic2_High_Column3 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic2_Low_Column3 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic1_High_Column4 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic1_Low_Column4 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic2_High_Column4 float NULL
		
ALTER TABLE T_LINK_MSN_POWERCENTER
ALTER COLUMN Ic2_Low_Column4 float NULL



--select * from T_LINK_MSN_POWERCENTER