...
' + CASE
	...
	WHEN MG = 0 AND TypeACDC = ''AC'' AND AllocatedPhase = ''A'' THEN
		CASE WHEN ISNULL(cast(NPP1 as varchar(8000)),'''')  = '''' THEN ''For AC 1ph and Allocated Phase A, Nominal Power PhA (V.A) is mandatory<br>'' ELSE '''' END +
		CASE WHEN ISNULL(cast(NPP2 as varchar(8000)),'''') <> '''' THEN ''For AC 1ph and Allocated Phase A, Nominal Power PhB (V.A) must be empty<br>'' ELSE '''' END +
		CASE WHEN ISNULL(cast(NPP3 as varchar(8000)),'''') <> '''' THEN ''For AC 1ph and Allocated Phase A, Nominal Power PhC (V.A) must be empty<br>'' ELSE '''' END
		
	WHEN MG = 0 AND TypeACDC = ''AC'' AND AllocatedPhase = ''B'' THEN
		CASE WHEN ISNULL(cast(NPP1 as varchar(8000)),'''') <> '''' THEN ''For AC 1ph and Allocated Phase B, Nominal Power PhA (V.A) must be empty<br>'' ELSE '''' END +
		CASE WHEN ISNULL(cast(NPP2 as varchar(8000)),'''')  = '''' THEN ''For AC 1ph and Allocated Phase B, Nominal Power PhB (V.A) is mandatory<br>'' ELSE '''' END +
		CASE WHEN ISNULL(cast(NPP3 as varchar(8000)),'''') <> '''' THEN ''For AC 1ph and Allocated Phase B, Nominal Power PhC (V.A) must be empty<br>'' ELSE '''' END
		
	WHEN MG = 0 AND TypeACDC = ''AC'' AND AllocatedPhase = ''C'' THEN
		CASE WHEN ISNULL(cast(NPP1 as varchar(8000)),'''') <> '''' THEN ''For AC 1ph and Allocated Phase C, Nominal Power PhA (V.A) must be empty<br>'' ELSE '''' END +
		CASE WHEN ISNULL(cast(NPP2 as varchar(8000)),'''') <> '''' THEN ''For AC 1ph and Allocated Phase C, Nominal Power PhB (V.A) must be empty<br>'' ELSE '''' END +
		CASE WHEN ISNULL(cast(NPP3 as varchar(8000)),'''')  = '''' THEN ''For AC 1ph and Allocated Phase C, Nominal Power PhC (V.A) is mandatory<br>'' ELSE '''' END
