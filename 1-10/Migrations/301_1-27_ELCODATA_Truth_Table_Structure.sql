-- ******************************************************************************
-- Name : 300_1-27_ELCODATA_Truth_Table_Structure.sql
-- Date : 12/08/2008
-- Spec : ELCODATA_V1.27_synthesis_sheet_A350_Truth_Tables.doc
-- Create Truth table Structure for PSE A350
-- Updated by FP to create only the columns needed
-- ******************************************************************************
...
CREATE TABLE dbo.Tmp_T_SSPC_VL
	...
	SSPC_VL_AfdxFallBackStatus varchar(50) NULL,
...
IF EXISTS(SELECT * FROM dbo.T_SSPC_VL)
	 EXEC('INSERT INTO dbo.Tmp_T_SSPC_VL (SSPC_VL_id, SSPC_VL_order, SSPC_VL_Designation, SSPC_VL_type, SSPC_VL_number, SSPC_VL_PinNumber, SSPC_VL_ConnectorNumber, SSPC_VL_VlName, SSPC_VL_VlIdentifier, SSPC_VL_UdpPort, SSPC_VL_SignalAddress, SSPC_VL_SignalPosition, SSPC_VL_AfdxFallBackStatus, SSPC_VL_TimeDelay1To0, SSPC_VL_TimeDelay0To1, SSPC_VL_TRUTH_TABLE_idr)
		SELECT SSPC_VL_id, SSPC_VL_order, SSPC_VL_Designation, SSPC_VL_type, SSPC_VL_number, SSPC_VL_PinNumber, SSPC_VL_ConnectorNumber, SSPC_VL_VlName, SSPC_VL_VlIdentifier, SSPC_VL_UdpPort, SSPC_VL_SignalAddress, SSPC_VL_SignalPosition, CONVERT(varchar(50), SSPC_VL_AfdxFallBackStatus), SSPC_VL_TimeDelay1To0, SSPC_VL_TimeDelay0To1, SSPC_VL_TRUTH_TABLE_idr FROM dbo.T_SSPC_VL TABLOCKX')
GO
