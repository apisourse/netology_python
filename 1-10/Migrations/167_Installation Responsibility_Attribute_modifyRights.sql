...
------------------------------------------------------------------------------------------------------------------
-- ins_Finresponsibility
------------------------------------------------------------------------------------------------------------------
SELECT @id_attr = id_infobase FROM InfoBase WHERE object_value = 'ins_Finresponsibility' AND table_name = 'V_Installation_responsibility'
...
-- ins_manufacturing
------------------------------------------------------------------------------------------------------------------
SELECT @id_attr = id_infobase FROM InfoBase WHERE object_value = 'ins_manufacturing' AND table_name = 'V_Installation_responsibility'
...
-- ins_name
------------------------------------------------------------------------------------------------------------------
SELECT @id_attr = id_infobase FROM InfoBase WHERE object_value = 'ins_name' AND table_name = 'V_Installation_responsibility'
...
-- ins_reasonforchange
------------------------------------------------------------------------------------------------------------------
SELECT @id_attr = id_infobase FROM InfoBase WHERE object_value = 'ins_reasonforchange' AND table_name = 'V_Installation_responsibility'
