...
-- def_name
------------------------------------------------------------------------------------------------------------------
SELECT @id_attr = id_infobase FROM InfoBase WHERE object_value = 'def_name' AND table_name = 'V_Definition_responsibility'
...
-- def_reasonforchange
------------------------------------------------------------------------------------------------------------------
SELECT @id_attr = id_infobase FROM InfoBase WHERE object_value = 'def_reasonforchange' AND table_name = 'V_Definition_responsibility'
...
-- def_reasonforchange
------------------------------------------------------------------------------------------------------------------
SELECT @id_attr = id_infobase FROM InfoBase WHERE object_value = 'def_DataOrigin' AND table_name = 'V_Definition_responsibility'
