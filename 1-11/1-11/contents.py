...
with open("files/flats.csv", newline="") as datafile: # newline - каждая линия чтения без отступов
...
csv.register_dialect('customcsv', delimiter=';', quoting=csv.ALL, quotechar='"', escapechar='\\') # зарегистрировать кастомный диалект с названием "customcsv". delimiter - разделитель; quoting - брать в кавычки; quotechar - понимание символа кавычек; escapechar - если экранируем символы, то через какой символ
